...
import 'admin/man_hinh_bao_cao_admin.dart';
import 'admin/man_hinh_quan_ly_luong_admin.dart';
import 'admin/man_hinh_cai_dat_admin.dart';
...
import 'manager/man_hinh_cai_dat_manager.dart';
...
import 'employee/man_hinh_ho_so.dart';
      ...
      builder: (context, state) {
        ...
        if (user.isAdmin) {
          ...
          screens = [
            ...
            const ManHinhBaoCaoAdmin(),
            const ManHinhQuanLyLuongAdmin(),
            const ManHinhCaiDatAdmin(),
          ];
...
// Placeholder screens for Manager/Employee
