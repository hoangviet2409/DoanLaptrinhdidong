...
namespace UngDungDiemDanhNhanVien.Migrations
{
    ...
    [Migration("20251020013711_AddPasswordToNhanVien")]
    partial class AddPasswordToNhanVien
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UngDungDiemDanhNhanVien.Models.QuanTriVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MatKhauHash = "$2a$11$PGwA1ckTO5l7LTkQsSqcMOna63rxOOU0WHYgTR2nURh/ZxB.4M80m",
                            NgayTao = new DateTime(2025, 10, 20, 8, 37, 10, 355, DateTimeKind.Local).AddTicks(3460),
                            TenDangNhap = "admin",
                            VaiTro = "Admin"
                        });
                });
