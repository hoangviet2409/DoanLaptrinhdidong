...
namespace UngDungDiemDanhNhanVien.Migrations
{
    ...
    [Migration("20251020012848_RemoveLoginFieldsFromNhanVien")]
    partial class RemoveLoginFieldsFromNhanVien
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UngDungDiemDanhNhanVien.Models.QuanTriVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MatKhauHash = "$2a$11$KDWEtYTEIy4UY8JWYufEjealpFPOfdbmcgqFIQ63MRhQNNNDXDCDm",
                            NgayTao = new DateTime(2025, 10, 20, 8, 28, 48, 51, DateTimeKind.Local).AddTicks(6156),
                            TenDangNhap = "admin",
                            VaiTro = "Admin"
                        });
                });
