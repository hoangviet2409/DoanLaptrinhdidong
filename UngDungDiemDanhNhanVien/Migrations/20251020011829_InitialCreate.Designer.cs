...
namespace UngDungDiemDanhNhanVien.Migrations
{
    ...
    [Migration("20251020011829_InitialCreate")]
            ...
            modelBuilder.Entity("UngDungDiemDanhNhanVien.Models.QuanTriVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MatKhauHash = "$2a$11$umOg3W0WNhvZWsrKBaJQFOtd9niNt7H.CVzwxpmX.MxfU/wv8WLgq",
                            NgayTao = new DateTime(2025, 10, 20, 8, 18, 28, 838, DateTimeKind.Local).AddTicks(8210),
                            TenDangNhap = "admin",
                            VaiTro = "Admin"
                        });
                });
